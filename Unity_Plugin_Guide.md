...
<manifest 
  ...
  <application 
    ...
    <activity 
      ...
      android:name="com.unity3d.player.UnityPlayerNativeActivity" exported="true">
      ...
      <meta-data android:name="unityplayer.UnityActivity" android:value="true" android:exported="true"/>
      <meta-data android:name="unityplayer.ForwardNativeEventsToDalvik" android:value="true" android:exported="true"/> <!-- set true -->
    </activity>
